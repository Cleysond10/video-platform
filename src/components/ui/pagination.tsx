...
const PaginationPrevButton = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
...
const PaginationNextButton = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
